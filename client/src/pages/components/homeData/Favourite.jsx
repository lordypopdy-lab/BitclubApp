    ...
    return (
        <div>
            ...
            <li style={{ marginTop: '18px' }}>
                <a data-bs-toggle="modal" data-bs-target="#detailChart" className="coin-item style-2 gap-12">
                    <img
                        src={priceBackup?.AVAX?.image || "/default-icon.png"}
                        alt="AVAX Logo"
                        className="img"
                    />
                    ...
                    <div className="content">
                        <div className="title">
                            <p className="mb-4 text-button">AVAX</p>
                            <span className="text-secondary">
                                ${formatVolume(pricesTicker?.AVAXUSDT?.volume || priceBackup?.AVAX?.volume || 0)}
                            </span>
                        </div>
                        <div className="d-flex align-items-center gap-12">
                            <span className="text-small">
                                {pricesTicker?.AVAXUSDT?.lastPrice
                                    ? `$${Number(pricesTicker.AVAXUSDT.lastPrice).toLocaleString(undefined, {
                                        minimumFractionDigits: 3,
                                        maximumFractionDigits: 3,
                                    })}`
                                    : `$${Number(priceBackup?.AVAX?.current_price || 0).toLocaleString(undefined, {
                                        minimumFractionDigits: 2,
                                        maximumFractionDigits: 2,
                                    })}`}
                            </span>
                            {pricesTicker.AVAXUSDT?.priceChangePercent !== undefined ? (
                                Number(pricesTicker.AVAXUSDT.priceChangePercent) > 0 ? (
                                    <span className="coin-btn increase">
                                        {Number(pricesTicker.AVAXUSDT.priceChangePercent).toLocaleString(undefined, {
                                            minimumFractionDigits: 3,
                                            maximumFractionDigits: 3,
                                        })}%
                                    </span>
                            ...
                            ) : priceBackup?.AVAX?.price_change_percentage_24h !== undefined ? (
                                priceBackup.AVAX.price_change_percentage_24h > 0 ? (
                                    <span className="coin-btn increase">
                                        {Number(priceBackup.AVAX.price_change_percentage_24h).toLocaleString(undefined, {
                                            minimumFractionDigits: 3,
                                            maximumFractionDigits: 3,
                                        })}%
                                    </span>
            ...
            <li style={{ marginTop: '18px' }}>
                <a data-bs-toggle="modal" data-bs-target="#detailChart" className="coin-item style-2 gap-12">
                    <img
                        src={priceBackup?.ADA?.image || "/default-icon.png"}
                        alt="ADA Logo"
                        className="img"
                    />
                    ...
                    <div className="content">
                        <div className="title">
                            <p className="mb-4 text-button">ADA</p>
                            <span className="text-secondary">
                            ${formatVolume(pricesTicker?.ADAUSDT?.volume || priceBackup?.ADA?.volume || 0)}
                                </span>
                        </div>
                        <div className="d-flex align-items-center gap-12">
                            <span className="text-small">
                                {pricesTicker?.ADAUSDT?.lastPrice
                                    ? `$${Number(pricesTicker.ADAUSDT.lastPrice).toLocaleString(undefined, {
                                        minimumFractionDigits: 3,
                                        maximumFractionDigits: 3,
                                    })}`
                                    : `$${Number(priceBackup?.ADA?.current_price || 0).toLocaleString(undefined, {
                                        minimumFractionDigits: 2,
                                        maximumFractionDigits: 2,
                                    })}`}
                            </span>
                            {pricesTicker.ADAUSDT?.priceChangePercent !== undefined ? (
                                Number(pricesTicker.ADAUSDT.priceChangePercent) > 0 ? (
                                    <span className="coin-btn increase">
                                        {Number(pricesTicker.ADAUSDT.priceChangePercent).toLocaleString(undefined, {
                                            minimumFractionDigits: 3,
                                            maximumFractionDigits: 3,
                                        })}%
                                    </span>
                            ...
                            ) : priceBackup?.ADA?.price_change_percentage_24h !== undefined ? (
                                priceBackup.ADA.price_change_percentage_24h > 0 ? (
                                    <span className="coin-btn increase">
                                        {Number(priceBackup.ADA.price_change_percentage_24h).toLocaleString(undefined, {
                                            minimumFractionDigits: 3,
                                            maximumFractionDigits: 3,
                                        })}%
                                    </span>
